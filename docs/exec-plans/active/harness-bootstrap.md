...
- [x] Repo skeleton and baseline tooling
- [x] Docs map and architecture foundations
...
1. Browser-level UI screenshots may vary by environment.
2. CI automerge constraints can require repository-level permission settings.
